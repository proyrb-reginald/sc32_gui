 ...
 *
 * @note    If the spinlock is locked, the current CPU will keep polling the spinlock
 * state until the spinlock is unlocked.
 *
...
/**
 * @brief   This function will unlock the spinlock and then restore current cpu interrupt
 * status.
 *
 * @param   lock is a pointer to the spinlock.
 *
