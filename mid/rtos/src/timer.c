 ...
 *        NOTE: The max timeout tick should be no more than (RT_TICK_MAX/2 - 1).
 *
 * @param flag is the flag of timer. Timer will invoke the timeout function according to
 * the selected values of flag, if one or more of the following flags is set.
 *
 ...
 *
 *        NOTE:
 *        You can use multiple values with "|" logical operator.  By default, system will
 * use the RT_TIME_FLAG_HARD_TIMER.
 *
...
rt_err_t rt_timer_control(rt_timer_t timer, int cmd, void * arg) {
    ...
    level = rt_hw_interrupt_disable();
    switch (cmd) {
        case RT_TIMER_CTRL_GET_TIME: *(rt_tick_t *)arg = timer->init_tick; break;
