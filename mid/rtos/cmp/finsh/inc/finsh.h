...
#            define MSH_FUNCTION_EXPORT_CMD(name, cmd, desc)                             \
                ...
                RT_USED const struct finsh_syscall __fsym_##cmd RT_SECTION(              \
                    "FSymTab") = {__fsym_##cmd##_name, __fsym_##cmd##_desc,              \
                                  (syscall_func) & name};
...
#            define MSH_FUNCTION_EXPORT_CMD(name, cmd, desc)                             \
                const char __fsym_##cmd##_name[] = #cmd;                                 \
                __declspec(allocate("FSymTab$f"))                                        \
                const struct finsh_syscall __fsym_##cmd = {__fsym_##cmd##_name,          \
                                                           (syscall_func) & name};
#            pragma comment(linker, "/merge:FSymTab=mytext")
...
#            define MSH_FUNCTION_EXPORT_CMD(name, cmd, desc)                             \
                const char                         __fsym_##cmd##_name[] = #cmd;         \
                RT_USED const struct finsh_syscall __fsym_##cmd RT_SECTION(              \
                    "FSymTab") = {__fsym_##cmd##_name, (syscall_func) & name};
