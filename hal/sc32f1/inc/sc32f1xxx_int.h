...
#define IS_INT_CHANNEL(CHANNEL)                                                          \
    (((CHANNEL) == INT_Channel_0) || ((CHANNEL) == INT_Channel_1) ||                     \
     ((CHANNEL) == INT_Channel_2) || ((CHANNEL) == INT_Channel_3) ||                     \
     ((CHANNEL) == INT_Channel_4) || ((CHANNEL) == INT_Channel_5) ||                     \
     ((CHANNEL) == INT_Channel_6) || ((CHANNEL) == INT_Channel_7) ||                     \
     ((CHANNEL) == INT_Channel_8) || ((CHANNEL) == INT_Channel_9) ||                     \
     ((CHANNEL) == INT_Channel_10) || ((CHANNEL) == INT_Channel_11) ||                   \
     ((CHANNEL) == INT_Channel_12) || ((CHANNEL) == INT_Channel_13) ||                   \
     ((CHANNEL) == INT_Channel_14) || ((CHANNEL) == INT_Channel_15))
/**
 * @}
 */
...
#    define IS_INT_INTSEL(INTSEL)                                                        \
        (((INTSEL) == INT_INTSEL_PA) || ((INTSEL) == INT_INTSEL_PB) ||                   \
...
#    define IS_INT_INTSEL(INTSEL)                                                        \
        (((INTSEL) == INT_INTSEL_PA) || ((INTSEL) == INT_INTSEL_PB) ||                   \
         ((INTSEL) == INT_INTSEL_PC) || ((INTSEL) == INT_INTSEL_PD))
#endif
/**
 * @}
 */
...
typedef enum {
    ...
    INT_Trigger_Rising_Falling =
        (uint16_t)0x03, /*!< INT Interrupt: Rising and Falling edge capture */
} INT_Trigger_TypeDef;

#define IS_INT_TRIGGER(TRIGGER)                                                          \
    (((TRIGGER) == INT_Trigger_Null) || ((TRIGGER) == INT_Trigger_Rising) ||             \
     ((TRIGGER) == INT_Trigger_Rising) || ((TRIGGER) == INT_Trigger_Rising_Falling))
/**
 * @}
 */
...
#define IS_INT_IT(IT)                                                                    \
    (((IT) == INT_IT_Null) || ((IT) == INT_IT_Rising) || ((IT) == INT_IT_Rising) ||      \
...
#define IS_INT_FLAG(FLAG) (((FLAG) == INT_Flag_Rising) || ((FLAG) == INT_Flag_Falling))
/**
 * @}
 */
...
typedef struct {
    uint16_t INT_Channel; /*!<  Specifies the INT channel.
                                                                                    This
                             parameter can be a value of @ref INT_ClockDivision */
