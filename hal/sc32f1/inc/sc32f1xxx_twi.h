...
#    define IS_TWI_ACK(STATE)                                                            \
        (((STATE) == TWI_Ack_Disable) || ((STATE) == TWI_Ack_Enable))
/**
 * @}
 */
...
typedef enum {
    ...
    TWI_PRESCALER_2048 =
        (uint16_t)(0x01U << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/2048 */
    TWI_PRESCALER_1024 =
        (uint16_t)(0x02U << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/1024 */
    TWI_PRESCALER_512 =
        (uint16_t)(0x03U << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/512  */
    TWI_PRESCALER_256 =
        (uint16_t)(0x04U << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/256  */
    TWI_PRESCALER_128 =
        (uint16_t)(0x05U << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/128  */
    TWI_PRESCALER_64 =
        (uint16_t)(0x06U << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/64    */
    TWI_PRESCALER_32 =
        (uint16_t)(0x07U << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/32    */
    TWI_PRESCALER_16 =
        (uint16_t)(0x08U << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/16    */
    TWI_PRESCALER_8 =
        (uint16_t)(0x09U << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/8    */
    TWI_PRESCALER_4 =
        (uint16_t)(0x0AU << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/4    */
} TWI_Prescaler_TypeDef;

#        define IS_TWI_PRESCALER(PRESCALER)                                              \
            (((PRESCALER) == TWI_PRESCALER_4) || ((PRESCALER) == TWI_PRESCALER_8) ||     \
             ((PRESCALER) == TWI_PRESCALER_16) || ((PRESCALER) == TWI_PRESCALER_32) ||   \
             ((PRESCALER) == TWI_PRESCALER_64) || ((PRESCALER) == TWI_PRESCALER_128) ||  \
             ((PRESCALER) == TWI_PRESCALER_256) || ((PRESCALER) == TWI_PRESCALER_512) || \
             ((PRESCALER) == TWI_PRESCALER_1024) ||                                      \
             ((PRESCALER) == TWI_PRESCALER_2048) || ((PRESCALER) == TWI_PRESCALER_4096))
#    else
...
typedef enum {
    ...
    TWI0_PRESCALER_4 =
        (uint16_t)(0x0AU << TWI_CON_TWCK_Pos), /*!< Clock division: Fsource/4    */
    TWI1_Prescaler_1 =
        (uint16_t)(0x00U << SPI1_TWI1_CON_QTWCK_Pos), /*!< Clock division: Fsource/1    */
    TWI1_Prescaler_2 =
        (uint16_t)(0x01U << SPI1_TWI1_CON_QTWCK_Pos), /*!< Clock division: Fsource/2    */
    TWI1_Prescaler_4 =
        (uint16_t)(0x02U << SPI1_TWI1_CON_QTWCK_Pos), /*!< Clock division: Fsource/4    */
    TWI1_Prescaler_8 =
        (uint16_t)(0x03U << SPI1_TWI1_CON_QTWCK_Pos), /*!< Clock division: Fsource/8    */
    TWI1_Prescaler_16 =
        (uint16_t)(0x04U << SPI1_TWI1_CON_QTWCK_Pos), /*!< Clock division: Fsource/16 */
    TWI1_Prescaler_32 =
        (uint16_t)(0x05U << SPI1_TWI1_CON_QTWCK_Pos), /*!< Clock division: Fsource/32 */
    TWI1_Prescaler_64 =
        (uint16_t)(0x06U << SPI1_TWI1_CON_QTWCK_Pos), /*!< Clock division: Fsource/64 */
    TWI1_Prescaler_128 =
        (uint16_t)(0x07U << SPI1_TWI1_CON_QTWCK_Pos), /*!< Clock division: Fsource/128 */
    TWI1_Prescaler_256 =
        (uint16_t)(0x08U << SPI1_TWI1_CON_QTWCK_Pos), /*!< Clock division: Fsource/256 */
    TWI1_Prescaler_512 =
        (uint16_t)(0x09U << SPI1_TWI1_CON_QTWCK_Pos), /*!< Clock division: Fsource/512 */
    TWI1_Prescaler_1024 =
        (uint16_t)(0x0AU << SPI1_TWI1_CON_QTWCK_Pos), /*!< Clock division: Fsource/1024 */
    TWI1_Prescaler_2048 =
...
#        define IS_TWI_PRESCALER(PRESCALER)                                              \
            (((PRESCALER) == TWI0_PRESCALER_4) || ((PRESCALER) == TWI0_PRESCALER_8) ||   \
             ((PRESCALER) == TWI0_PRESCALER_16) || ((PRESCALER) == TWI0_PRESCALER_32) || \
             ...
             ((PRESCALER) == TWI1_Prescaler_1) || ((PRESCALER) == TWI1_Prescaler_2) ||   \
             ((PRESCALER) == TWI1_Prescaler_4) || ((PRESCALER) == TWI1_Prescaler_8) ||   \
             ((PRESCALER) == TWI1_Prescaler_16) || ((PRESCALER) == TWI1_Prescaler_32) || \
 ...
 */
typedef enum {
    TWI_Stretch_Disable = 0X00U
                          << TWI_CON_STRETCH_Pos, /*!< TWI Slave Clock Stretch:Disable */
    TWI_Stretch_Enable =
        0X01U << TWI_CON_STRETCH_Pos, /*!< TWI Slave Clock Stretch:Enable   */
} TWI_Stretch_TypeDef;

#    define IS_TWI_STRETCH(STRETCH)                                                      \
        (((STRETCH) == TWI_Stretch_Enable) || ((STRETCH) == TWI_Stretch_Disable))
/**
 * @}
 */
 ...
 */
typedef enum {
    TWI_GeneralCall_Disable = 0X00U
                              << TWI_ADD_GC_Pos, /*!< TWI General Call State:Disable    */
    TWI_GeneralCall_Enable = 0X01U
                             << TWI_ADD_GC_Pos, /*!< TWI General Call State:Enable    */
} TWI_GeneralCall_TypeDef;

#    define IS_TWI_GENERALCALL(GENERALCALL)                                              \
        (((GENERALCALL) == TWI_GeneralCall_Disable) ||                                   \
...
#    define IS_TWI_COMMAND(COMMAND)                                                      \
        (((COMMAND) == TWI_Command_Write) || ((COMMAND) == TWI_Command_Read))
/**
 * @}
 */
...
typedef enum {
    ...
    TWI_PinRemap_A =
        (uint32_t)(0x01 << TWI_CON_SPOS_Pos), /*!< TIM Pin Remap: Remap mode A */
    TWI_PinRemap_B =
        (uint32_t)(0x02 << TWI_CON_SPOS_Pos), /*!< TIM Pin Remap: Remap mode B */
    TWI_PinRemap_C =
        (uint32_t)(0x03 << TWI_CON_SPOS_Pos), /*!< TIM Pin Remap: Remap mode C */
} TWI_PinRemap_TypeDef;

#        define IS_TWI_LIST1_PINREMAP(REMAP)                                             \
            (((REMAP) == TWI_PinRemap_Default) || ((REMAP) == TWI_PinRemap_A) ||         \
             ((REMAP) == TWI_PinRemap_B) || ((REMAP) == TWI_PinRemap_C))

#        define IS_TWI_LIST2_PINREMAP(REMAP)                                             \
            (((REMAP) == TWI_PinRemap_Default) || ((REMAP) == TWI_PinRemap_A) ||         \
...
typedef enum {
    ...
    TWI_PinRemap_C =
        (uint32_t)(0x03 << TWI_CON_SPOS_Pos), /*!< TIM Pin Remap: Remap mode C */
    TWI_PinRemap_D =
        (uint32_t)(0x04 << TWI_CON_SPOS_Pos), /*!< TIM Pin Remap: Remap mode D */
    TWI_PinRemap_E =
        (uint32_t)(0x05 << TWI_CON_SPOS_Pos), /*!< TIM Pin Remap: Remap mode E */
} TWI_PinRemap_TypeDef;

#        define IS_TWI_LIST1_PINREMAP(REMAP)                                             \
            (((REMAP) == TWI_PinRemap_Default) || ((REMAP) == TWI_PinRemap_A) ||         \
             ((REMAP) == TWI_PinRemap_B) || ((REMAP) == TWI_PinRemap_C) ||               \
             ((REMAP) == TWI_PinRemap_D) || ((REMAP) == TWI_PinRemap_E))
...
#    define IS_TWI_DMAREQ(DMAREQ)                                                        \
        (((DMAREQ) == TWI_DMAReq_RX) || ((DMAREQ) == TWI_DMAReq_TX))
/**
 * @}
 */
...
typedef enum {
    ...
    TWI_FLAG_TXRXnE =
        (uint32_t)TWI_STS_TXERXE, /*!< TWI Flag: Transmit/receive completion flag */
    TWI_FLAG_GCA = (uint32_t)TWI_STS_GCA, /*!< TWI Flag: Generic Call flags */
    TWI_FLAG_MSTR =
        (uint32_t)TWI_STS_MSTR, /*!< TWI Flag: Flag to identify master or slave */
} TWI_FLAG_TypeDef;

#        define IS_TWI_FLAG(FLAG)                                                        \
            (((FLAG) == TWI_FLAG_TWIF) || ((FLAG) == TWI_FLAG_TXRXnE) ||                 \
             ((FLAG) == TWI_FLAG_GCA) || ((FLAG) == TWI_FLAG_MSTR))
#    else
...
#        define IS_TWI_FLAG(FLAG)                                                        \
            (((FLAG) == TWI_FLAG_TWIF) || ((FLAG) == TWI_FLAG_TXRXnE) ||                 \
             ((FLAG) == TWI_FLAG_GCA) || ((FLAG) == TWI_FLAG_QTWIF))
#    endif
...
typedef enum {
    TWI_Prescaler_1 =
        (uint16_t)(0x00U << TWI_QSPIx_CON_QTWCK_Pos), /*!< Clock division: Fsource/1    */
    TWI_Prescaler_2 =
        (uint16_t)(0x01U << TWI_QSPIx_CON_QTWCK_Pos), /*!< Clock division: Fsource/2    */
    TWI_Prescaler_4 =
        (uint16_t)(0x02U << TWI_QSPIx_CON_QTWCK_Pos), /*!< Clock division: Fsource/4    */
    TWI_Prescaler_8 =
        (uint16_t)(0x03U << TWI_QSPIx_CON_QTWCK_Pos), /*!< Clock division: Fsource/8    */
    TWI_Prescaler_16 =
        (uint16_t)(0x04U << TWI_QSPIx_CON_QTWCK_Pos), /*!< Clock division: Fsource/16 */
    TWI_Prescaler_32 =
        (uint16_t)(0x05U << TWI_QSPIx_CON_QTWCK_Pos), /*!< Clock division: Fsource/32 */
    TWI_Prescaler_64 =
        (uint16_t)(0x06U << TWI_QSPIx_CON_QTWCK_Pos), /*!< Clock division: Fsource/64 */
    TWI_Prescaler_128 =
        (uint16_t)(0x07U << TWI_QSPIx_CON_QTWCK_Pos), /*!< Clock division: Fsource/128 */
    TWI_Prescaler_256 =
        (uint16_t)(0x08U << TWI_QSPIx_CON_QTWCK_Pos), /*!< Clock division: Fsource/256 */
    TWI_Prescaler_512 =
        (uint16_t)(0x09U << TWI_QSPIx_CON_QTWCK_Pos), /*!< Clock division: Fsource/512 */
    TWI_Prescaler_1024 =
        (uint16_t)(0x0AU << TWI_QSPIx_CON_QTWCK_Pos), /*!< Clock division: Fsource/1024 */
    TWI_Prescaler_2048 =
        (uint16_t)(0x0BU << TWI_QSPIx_CON_QTWCK_Pos), /*!< Clock division: Fsource/2048 */
    TWI_Prescaler_4096 =
        (uint16_t)(0x0CU << TWI_QSPIx_CON_QTWCK_Pos), /*!< Clock division: Fsource/2048 */
} TWI_Prescaler_TypeDef;

#    define IS_TWI_PRESCALER(PRESCALER)                                                  \
        (((PRESCALER) == TWI_Prescaler_1) || ((PRESCALER) == TWI_Prescaler_2) ||         \
         ((PRESCALER) == TWI_Prescaler_4) || ((PRESCALER) == TWI_Prescaler_8) ||         \
         ((PRESCALER) == TWI_Prescaler_16) || ((PRESCALER) == TWI_Prescaler_32) ||       \
         ((PRESCALER) == TWI_Prescaler_64) || ((PRESCALER) == TWI_Prescaler_128) ||      \
         ((PRESCALER) == TWI_Prescaler_256) || ((PRESCALER) == TWI_Prescaler_512) ||     \
         ((PRESCALER) == TWI_Prescaler_1024) || ((PRESCALER) == TWI_Prescaler_2048) ||   \
...
typedef enum {
    TWI_Stretch_Disable =
        0X00U << TWI_QSPIx_CON_STRETCH_Pos, /*!< TWI Slave Clock Stretch:Disable    */
    TWI_Stretch_Enable =
        0X01U << TWI_QSPIx_CON_STRETCH_Pos, /*!< TWI Slave Clock Stretch:Enable */
} TWI_Stretch_TypeDef;
 ...
 */
typedef enum {
    TWI_GeneralCall_Disable =
        0X00U << TWI_QSPIx_ADD_GC_Pos, /*!< TWI General Call State:Disable */
    TWI_GeneralCall_Enable =
        0X01U << TWI_QSPIx_ADD_GC_Pos, /*!< TWI General Call State:Enable    */
} TWI_GeneralCall_TypeDef;
...
typedef enum {
    TWI_PinRemap_Default =
        (uint32_t)(0x00 << TWI_QSPIx_CON_SPOS_Pos), /*!< TIM Pin Remap: Disable */
    TWI_PinRemap_A =
        (uint32_t)(0x01 << TWI_QSPIx_CON_SPOS_Pos), /*!< TIM Pin Remap: Remap mode A */
    TWI_PinRemap_B =
        (uint32_t)(0x02 << TWI_QSPIx_CON_SPOS_Pos), /*!< TIM Pin Remap: Remap mode B */
    TWI_PinRemap_C =
        (uint32_t)(0x03 << TWI_QSPIx_CON_SPOS_Pos), /*!< TIM Pin Remap: Remap mode C */
} TWI_PinRemap_TypeDef;
...
#    define IS_TWI_STATEMACHINE(STATE)                                                   \
        (((STATE) == TWI_Slave_Idle) || ((STATE) == TWI_Slave_ReceivedaAddress) ||       \
         ((STATE) == TWI_Slave_ReceivedaData) || ((STATE) == TWI_Slave_SendData) ||      \
         ((STATE) == TWI_Slave_ReceivedaUACK) || ((STATE) == TWI_Master_Idle) ||         \
         ((STATE) == TWI_Master_SendAddress) || ((STATE) == TWI_Master_SendData) ||      \
         ((STATE) == TWI_Master_ReceivedaData))
/**
 * @}
 */
...
typedef enum {
    ...
    TWI_IT_QTWIE =
        (uint32_t)TWI_SPIx_IDE_QTWIE, /*!< TWI Interrupt: TWI total interruption */
} TWI_IT_TypeDef;
...
typedef enum {
    TWI_FLAG_TXRXnE =
        (uint16_t)TWI_QSPIx_STS_TXERXE, /*!< TWI Flag: Transmit/receive completion flag */
...
#    define IS_TWI_FLAG(FLAG)                                                            \
        (((FLAG) == TWI_FLAG_TXRXnE) || ((FLAG) == TWI_FLAG_GCA) ||                      \
         ((FLAG) == TWI_FLAG_QTWIF))
...
#    define IS_TWI_ALL_PERIPH(PERIPH)                                                    \
        (((PERIPH) == TWI0) || ((PERIPH) == TWI1) || ((PERIPH) == TWI2) ||               \
         ((PERIPH) == TWI3))
#endif
/**
 * @}
...
typedef struct {
    ...
    uint32_t
        TWI_SlaveAdress; /*!< This member configures TWI SlaveAdress.
...
void    TWI_Send7bitAddress(TWI_TypeDef *       TWIx,
                            uint8_t             Address,
                            TWI_Command_TypeDef TWI_Command);
...
void                     TWI_DMACmd(TWI_TypeDef *      TWIx,
                                    TWI_DMAReq_TypeDef TWI_DMAReq,
