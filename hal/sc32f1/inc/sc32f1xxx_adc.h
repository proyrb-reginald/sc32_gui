...
#define IS_ADC_CONVMODE(MODE)                                                            \
    (((MODE) == ADC_ConvMode_Single) || ((MODE) == ADC_ConvMode_Continuous))
/**
 * @}
 */
...
typedef enum {
    ...
    ADC_Prescaler_6CLOCK =
        (uint32_t)(0x05 << ADC_CON_LOWSP_Pos), /*!<The sampling time is 6 APB2 clocks */
    ...
    ADC_Prescaler_6CLOCK =
        (uint32_t)(0x01 << ADC_CON_LOWSP_Pos), /* The sampling time is 6   APB2 clocks */
    ADC_Prescaler_9CLOCK =
        (uint32_t)(0x02 << ADC_CON_LOWSP_Pos), /* The sampling time is 9   APB2 clocks */
    ADC_Prescaler_15CLOCK =
        (uint32_t)(0x03 << ADC_CON_LOWSP_Pos), /* The sampling time is 15  APB2 clocks */
    ADC_Prescaler_30CLOCK =
        (uint32_t)(0x04 << ADC_CON_LOWSP_Pos), /* The sampling time is 30  APB2 clocks */
    ADC_Prescaler_60CLOCK =
        (uint32_t)(0x05 << ADC_CON_LOWSP_Pos), /* The sampling time is 60  APB2 clocks */
    ADC_Prescaler_120CLOCK =
        (uint32_t)(0x06 << ADC_CON_LOWSP_Pos), /* The sampling time is 120 APB2 clocks */
    ADC_Prescaler_480CLOCK =
...
#elif defined(SC32R601)
#    define IS_ADC_CHANNEL(CHANNEL)                                                      \
        ((CHANNEL) <= ADC_Channel_15 || (CHANNEL) == ADC_Channel_VDD_D4)
#endif
/**
 * @}
 */
...
typedef enum {
    ...
    ADC_VREF_2_048V =
        (uint32_t)(0x01 << ADC_CON_VREFS_Pos), /*!< ADC reference voltage is 2.048V */
    ADC_VREF_1_024V =
...
typedef enum {
    ...
    ADC_IT_EOSIE0 = (uint16_t)ADC_IDE_EOSIE0,   /*!< ADC sequence 0 sampling + conversion
                                                   complete interrupt Flag */
    ADC_IT_UPTHIE  = (uint16_t)ADC_IDE_UPTHIE,  /*!< ADC upper threshold overflow Flag */
    ADC_IT_LOWTHIE = (uint16_t)ADC_IDE_LOWTHIE, /*!< ADC lower threshold overflow Flag */
#endif
} ADC_IT_TypeDef;
...
void ADC_ThresholdsChannelConfig(ADC_TypeDef *   ADCx,
                                 uint32_t        ADC_Thresholds_Channel,
