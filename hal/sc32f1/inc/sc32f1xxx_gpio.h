...
#define IS_GPIO_MODE(MODE)                                                               \
    (((MODE) == GPIO_Mode_IN_HI) || ((MODE) == GPIO_Mode_IN_PU) ||                       \
...
#define IS_GPIO_DriveLevel(LEVEL)                                                        \
    (((LEVEL) == GPIO_DriveLevel_0) || ((LEVEL) == GPIO_DriveLevel_1) ||                 \
     ((LEVEL) == GPIO_DriveLevel_2) || ((LEVEL) == GPIO_DriveLevel_3))
...
typedef struct {
    ...
    uint16_t GPIO_DriveLevel; /*!< Specifies the operating Drive Level for the selected
