...
typedef enum {
    PWM_PRESCALER_DIV1 =
        (uint16_t)(0x00U << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/1 */
    PWM_PRESCALER_DIV2 =
        (uint16_t)(0x01U << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/2 */
    PWM_PRESCALER_DIV4 =
        (uint16_t)(0x02U << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/4 */
    PWM_PRESCALER_DIV8 =
        (uint16_t)(0x03U << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/8 */
    PWM_PRESCALER_DIV16 =
        (uint16_t)(0x04U << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/16    */
    PWM_PRESCALER_DIV32 =
        (uint16_t)(0x05U << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/32    */
    PWM_PRESCALER_DIV64 =
        (uint16_t)(0x06U << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/64    */
    PWM_PRESCALER_DIV128 =
        (uint16_t)(0x07U << PWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/128    */
} PWM_Prescaler_TypeDef;

#define IS_PWM_PRESCALER(PRESCALER)                                                      \
    (((PRESCALER) == PWM_PRESCALER_DIV1) || ((PRESCALER) == PWM_PRESCALER_DIV2) ||       \
     ((PRESCALER) == PWM_PRESCALER_DIV4) || ((PRESCALER) == PWM_PRESCALER_DIV8) ||       \
     ((PRESCALER) == PWM_PRESCALER_DIV16) || ((PRESCALER) == PWM_PRESCALER_DIV32) ||     \
     ((PRESCALER) == PWM_PRESCALER_DIV64) || ((PRESCALER) == PWM_PRESCALER_DIV128) ||    \
 ...
 */
typedef enum {
    PWM_AlignmentMode_Edge =
        (uint16_t)(0x00U << PWM_CON_PWMMD0_Pos), /*!< Edge Alignment mode */
    PWM_AlignmentMode_Center =
        (uint16_t)(0x01U << PWM_CON_PWMMD0_Pos), /*!< Center Alignment mode */
} PWM_AlignedMode_TypeDef;

#define IS_PWM_AlignedMode(MODE)                                                         \
    (((MODE) == PWM_AlignmentMode_Edge) || ((MODE) == PWM_AlignmentMode_Center))
/**
 * @}
 */
...
typedef enum {
    PWM_WorkMode_Independent =
        (uint16_t)(0x00U << PWM_CON_PWMMD1_Pos), /*!< Independent working mode */
    PWM_WorkMode_Complementary =
        (uint16_t)(0x01U << PWM_CON_PWMMD1_Pos), /*!< Complementary working mode*/
} PWM_WorkMode_TypeDef;

#define IS_PWM_WORKMode(MODE)                                                            \
    (((MODE) == PWM_Mode_Independent) || ((MODE) == PWM_Mode_Complementary))
/**
 * @}
 */
...
typedef enum {
    PWM_FDMode_Latch =
        (uint16_t)(0x00U
                   << PWM_FLT_FLTMD_Pos), /*!< PWM fault detection mode: Latch mode */
    PWM_FDMode_Immediate =
        (uint16_t)(0x01U
                   << PWM_FLT_FLTMD_Pos), /*!< PWM fault detection mode: Immediate mode */
} PWM_FDMode_TypeDef;

#define IS_PWM_FDMODE(MODE)                                                              \
    (((MODE) == PWM_FDMode_Latch) || ((MODE) == PWM_FDMode_Immediate))
/**
 * @}
 */
...
typedef enum {
    PWM_FDVoltage_Low =
        (uint16_t)(0x00U
                   << PWM_FLT_FLTTV_Pos), /*!< PWM fault detection Voltage:Low level */
    PWM_FDVoltage_High =
        (uint16_t)(0x01U
                   << PWM_FLT_FLTTV_Pos), /*!< PWM fault detection Voltage:High level */
} PWM_FDVoltage_TypeDef;

#define IS_PWM_FDVOLTAGE(VOLTAGE)                                                        \
    (((VOLTAGE) == PWM_FDVoltage_Low) || ((VOLTAGE) == PWM_FDVoltage_High))
/**
 * @}
 */
...
typedef enum {
    PWM_FilteringTime_0us =
        (uint16_t)(0x00U << PWM_FLT_FLTDT_Pos), /*!< PWM fault detection input signal
                                                   filtering time is 0us */
    PWM_FilteringTime_1us =
        (uint16_t)(0x01U << PWM_FLT_FLTDT_Pos), /*!< PWM fault detection input signal
                                                   filtering time is 1us */
    PWM_FilteringTime_4us =
        (uint16_t)(0x02U << PWM_FLT_FLTDT_Pos), /*!< PWM fault detection input signal
                                                   filtering time is 4us */
    PWM_FilteringTime_16us =
        (uint16_t)(0x03U << PWM_FLT_FLTDT_Pos), /*!< PWM fault detection input signal
                                                   filtering time is 16us */
} PWM_FDFilteringTime_TypeDef;

#define IS_PWM_FDFILTERINGTIME(TIME)                                                     \
    (((TIME) == PWM_WaveFilteringTime_0us) || ((TIME) == PWM_WaveFilteringTime_1us) ||   \
     ((TIME) == PWM_WaveFilteringTime_4us) || ((TIME) == PWM_WaveFilteringTime_16us))
/**
 * @}
 */
...
#define IS_PWM_FLAG(FLAG)                                                                \
    ((((FLAG) & (uint8_t)0xFC) == 0x00) && ((FLAG) != (uint8_t)0x00))

#define IS_GET_PWM_FLAG(FLAG) (((FLAG) == PWM_Flag_PWMIF) || ((FLAG) == PWM_Flag_FLTSTA))
/**
 * @}
 */
...
typedef struct {
    uint16_t PWM_Prescaler; /*!<  Specifies the predivision.
                                                                            This parameter
                               can be a value of @ref PWM_Prescaler_TypeDef */

    uint16_t PWM_AlignedMode; /*!< Specifies the aligne mode.
                                                                            This parameter
                                 can be a value of @ref PWM_AlignedMode_TypeDef */

    uint16_t PWM_WorkMode; /*!< Specifies the work mode.
                                                                                    This
                              parameter can be a value of @ref PWM_WorkMode_TypeDef */
    ...
    uint32_t PWM_OutputChannel; /*!< Specifies the output Channel.
                                                                             This
                                   parameter can be a value of @ref PWM_CHANNEL_Typedef */

    uint32_t
        PWM_LowPolarityChannl; /*!< Specifies the invert Channel.
                                                                            This parameter
                                  can be a value of @ref PWM_CHANNEL_Typedef */
} PWM_InitTypeDef;
/**
 * @}
 */
...
typedef struct {
    uint16_t PWM_FDMode;    /*!<  Specifies the PWM fault detection mode.
                                                                                This
                               parameter can be a    value of @ref PWM_FDMode_TypeDef */
    uint16_t PWM_FDVoltage; /*!<  Specifies the PWM fault detection active level.
                                                                                This
                               parameter can be a value of @ref PWM_FDVoltage_TypeDef */
    uint16_t
        PWM_FDFilteringTime; /*!<  Specifies the PWM fault detection filtering time.
                                                                        This parameter can
                                be a value of @ref PWM_FDFilteringTime_TypeDef */
} PWM_FDInitTypeDef;
/**
 * @}
 */
