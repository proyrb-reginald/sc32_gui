...
typedef enum {
    ...
    RCC_SYSCLKSource_LIRC =
        (uint16_t)((0x00 << RCC_CFG0_SYSCLKSEL_Pos)), /*!< SYSCLK Source    LIRC */
    RCC_SYSCLKSource_HXT =
        (uint16_t)((0x01 << RCC_CFG0_SYSCLKSEL_Pos)), /*!< SYSCLK Source    HXT */
    RCC_SYSCLKSource_PLLRCLK =
        (uint16_t)((0x02 << RCC_CFG0_SYSCLKSEL_Pos)), /*!< SYSCLK Source    PLLCK */
    RCC_SYSCLKSource_LXT =
        (uint16_t)((0x03 << RCC_CFG0_SYSCLKSEL_Pos)), /*!< SYSCLK Source    LXT */
...
typedef enum {
    RCC_SYSCLKSource_HIRC_2 =
        (uint16_t)(~RCC_CFG0_SYSCLKSW), /*!< SYSCLK Source    HIRC/2 */
    RCC_SYSCLKSource_LIRC =
        (uint16_t)((0x00 << RCC_CFG0_SYSCLKSEL_Pos)), /*!< SYSCLK Source    LIRC */
    RCC_SYSCLKSource_HXT =
        (uint16_t)((0x01 << RCC_CFG0_SYSCLKSEL_Pos)), /*!< SYSCLK Source    HXT */
    RCC_SYSCLKSource_HIRC =
        (uint16_t)((0x02 << RCC_CFG0_SYSCLKSEL_Pos)), /*!< SYSCLK Source    HIRC */
    RCC_SYSCLKSource_LXT =
        (uint16_t)((0x03 << RCC_CFG0_SYSCLKSEL_Pos)), /*!< SYSCLK Source    LXT */
} RCC_SYSCLKSource_TypeDef;
...
#    define IS_RCC_SYSTICKSOURCE(SOURCE)                                                 \
        (((SOURCE) == RCC_SysTickSource_HCLK_DIV8) ||                                    \
         ((SOURCE) == RCC_SysTickSource_HIRC_DIV2) ||                                    \
         ((SOURCE) == RCC_SysTickSource_HXT_DIV2) ||                                     \
         ((SOURCE) == RCC_SysTickSource_LIRC) || ((SOURCE) == RCC_SysTickSource_LXT) ||  \
...
typedef enum {
    ...
    RCC_SYSCLK_Div16 =
        (uint32_t)(0x04 << AHB_CFG_CLKDIV_Pos), /*!< AHB clock = SYSCLK/16 */
} RCC_HCLK_TypeDef;
...
#    define IS_RCC_PCLK(PCLK)                                                            \
        (((PCLK) == RCC_HCLK_Div1) || ((PCLK) == RCC_HCLK_Div2) ||                       \
         ...
         ((PCLK) == RCC_HCLK_Div16) || ((PCLK) == RCC_HCLK_Div32) ||                     \
         ((PCLK) == RCC_HCLK_Div64) || ((PCLK) == RCC_HCLK_Div128))
/**
 * @}
 */
...
typedef enum {
    ...
    RCC_LCDLEDCLKSource_LXT =
        (uint32_t)(0x01 << RCC_CFG1_LCDCLKSEL_Pos), /*!< LCD_LED clock = LXT */
} RCC_LCDLEDCLKSource_TypeDef;

#        define RCC_LCDLEDCLKSOURCE(SOURCE)                                              \
            (((SOURCE) == RCC_LCDLEDCLKSource_LIRC) ||                                   \
...
typedef enum {
    RCC_BTMCLKSource_LIRC =
        (uint32_t)(0x00 << RCC_CFG1_BTMCLKSEL_Pos), /*!< BTM clock = LIRC */
    RCC_BTMCLKSource_LXT =
        (uint32_t)(0x01 << RCC_CFG1_BTMCLKSEL_Pos), /*!< BTM clock = LXT */
} RCC_BTMCLKSource_TypeDef;

#    define RCC_BTMCLKSOURCE(SOURCE)                                                     \
        (((SOURCE) == RCC_BTMCLKSource_LIRC) || ((SOURCE) == RCC_BTMCLKSource_LXT))
 ...
 */
typedef enum {
    RCC_PLLCLKSource_HIRC =
        (uint32_t)(0x00 << PLL_CFG_PLLCLKSEL_Pos), /*!< PLL clock = HIRC */
    RCC_PLLCLKSource_HXT =
        (uint32_t)(0x01 << PLL_CFG_PLLCLKSEL_Pos), /*!< PLL clock = HXT */
} RCC_PLLCLKSource_TypeDef;

#        define RCC_PLLCLKSOURCE(SOURCE)                                                 \
            (((SOURCE) == RCC_PLLCLKSource_HXT) || ((SOURCE) == RCC_PLLCLKSource_HIRC))
/**
 * @}
 */
#    endif
...
typedef enum {
    ...
    RCC_PWM0CLKSource_Div1HIRC =
        (uint32_t)(0x01 << RCC_CFG1_PWM0CLKSEL_Pos), /*!< PWM0 clock = HIRC */
...
typedef enum {
    RCC_PWM0CLKSource_PCLK =
        (uint32_t)(0x00 << RCC_CFG1_PWM0CLKSEL_Pos), /*!< PWM0 clock = PCLK */
    RCC_PWM0CLKSource_PLLQ =
        (uint32_t)(0x01 << RCC_CFG1_PWM0CLKSEL_Pos), /*!< PWM0 clock = PLL */
} RCC_PWM0CLKSource_TypeDef;

#        define RCC_PWM0CLKSOURCE(SOURCE)                                                \
            (((SOURCE) == RCC_PWM0CLKSource_PCLK) || ((SOURCE) == RCC_PWM0CLKSource_PLLQ))
#    endif
/**
 * @}
 */
...
#        define IS_RCC_AHBPERIPH(PERIPH)                                                 \
            ((((PERIPH) & (uint8_t)0xE8) == 0x00) && ((PERIPH) != (uint8_t)0x00))
#    endif
/**
 * @}
 */
...
#        define IS_RCC_APB0PERIPH(PERIPH)                                                \
            ((((PERIPH) & (uint8_t)0x0C) == 0x00) && ((PERIPH) != (uint16_t)0x00))
#    endif
...
#        define IS_RCC_APB1PERIPH(PERIPH)                                                \
            ((((PERIPH) & (uint8_t)0xFF60) == 0x00) && ((PERIPH) != (uint16_t)0x00))
...
#        define IS_RCC_APB1PERIPH(PERIPH)                                                \
            ((((PERIPH) & (uint8_t)0xFF6C) == 0x00) && ((PERIPH) != (uint16_t)0x00))
...
#        define IS_RCC_APB2PERIPH(PERIPH)                                                \
            ((((PERIPH) & (uint8_t)0xFFA0) == 0x00) && ((PERIPH) != (uint16_t)0x00))
#    endif
/**
 * @}
 */
...
#    define IS_RCC_Wait(Wait)                                                            \
        (((Wait) == RCC_WAIT_0) || ((Wait) == RCC_WAIT_1) || ((Wait) == RCC_WAIT_2) ||   \
         ((Wait) == RCC_WAIT_3))
...
typedef enum {
    ...
    RCC_FLAG_LOCKERR =
        (uint8_t)RCC_STS_LOCKERR, /*!< RCC FLAG: PLL out-of-lock record flag */
    RCC_FLAG_PLLRDY = (uint8_t)RCC_STS_PLLRDY, /*!< RCC FLAG: PLL Clock Ready Flag */
} RCC_FLAG_TypeDef;

#        define IS_RCC_FLAG(FLAG)                                                        \
            ((((FLAG) & (uint8_t)0xFFF8) == 0x00) && ((FLAG) != (uint16_t)0x00))
