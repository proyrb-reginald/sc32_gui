...
/** @addtogroup sc32f1xxx_System_Exported_Constants
 * @{
 */
...
/** @addtogroup sc32f1xxx_System_Exported_Macros
 * @{
 */
...
/** @addtogroup sc32f1xxx_System_Exported_Functions
 * @{
 */
