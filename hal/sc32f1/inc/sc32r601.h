 ...
 *          definitions and memory mapping for SC32R601 devices.
 *
 *          This file contains:
...
#    define __NVIC_PRIO_BITS                                                             \
        2U /*!< SC32R601 uses 2 Bits for the Priority Levels 			*/
...
/**
 * @brief SC32R601 Interrupt Number Definition, according to the selected device
...
typedef enum {
    ...
    /******  SC32R601 specific Interrupt Numbers
     ****************************************************************/
...
typedef struct {
    ...
    __IO uint32_t CAN_TTSL;
        /*!< CAN TimestampLow Timer register, Address offset: 0xD0 */ /*V0.3 */
    __IO uint32_t
        CAN_TTSH; /*!< CAN TimestampHigh Timer register,    Address offset: 0xD4 */
...
typedef struct {
    ...
    /*!< CAN TimestampHigh Timer register,    Address offset: 0xD4 */ /*V0.3    */
} CAN_TypeDef;
