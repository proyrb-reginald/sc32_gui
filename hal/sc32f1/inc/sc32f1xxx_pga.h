...
typedef enum {
    PGA_INSEL_PGAI0 =
        (uint16_t)(0x00U
                   << PGA_CON_PGAINSEL_Pos), /*!< The current PGA signal input is PGAI0 */
    PGA_INSEL_PGAI1 =
        (uint16_t)(0x01U
                   << PGA_CON_PGAINSEL_Pos), /*!< The current PGA signal input is PGAI1 */
} PGA_INSEL_TypeDef;

#define IS_PGA_INSEL(COM) (((COM) == PGA_INSEL_PGAI0) || ((COM) == PGA_INSEL_PGAI1))
...
typedef enum {
    PGA_COM_0V =
        (uint16_t)(0x00U << PGA_CON_PGACOM_Pos), /*!< The common-mode voltage : 0V    */
    PGA_COM_1_2V =
        (uint16_t)(0x01U << PGA_CON_PGACOM_Pos), /*!< The common-mode voltage : 1.2V */
} PGA_COM_TypeDef;
...
typedef enum {
    PGA_GAN_Invert19 =
        (uint16_t)((0x00U << PGA_CON_PGAGAN_Pos) |
                   PGA_CON_PGAIPT), /*!< The PGA inverting input gain is 19 times  */
    PGA_GAN_Invert99 =
        (uint16_t)((0x01U << PGA_CON_PGAGAN_Pos) |
                   PGA_CON_PGAIPT), /*!< The PGA inverting input gain is 99 times */

    PGA_GAN_NonInvert20 =
        (uint16_t)(0x00U
                   << PGA_CON_PGAGAN_Pos), /*!< The PGA in-phase input gain is 20 times */
    PGA_GAN_NonInvert100 =
        (uint16_t)(0x01U << PGA_CON_PGAGAN_Pos), /*!< The PGA in-phase input gain is 100
                                                    times  */
} PGA_GAN_TypeDef;
