 ...
 *          definitions and memory mapping for sc32r803 devices.
 *
 *          This file contains:
...
#        define HXT_VALUE                                                                \
            ((uint32_t)16000000) /*!< Default value of the External oscillator in Hz */
#    endif                       /* HXT_VALUE */
...
#        define LXT_VALUE                                                                \
            ((uint32_t)32768) /*!< Default value of the External Low speed oscillator in \
                                 Hz */
#    endif                    /* HXT_VALUE */

#    if !defined(LIRC_VALUE)
#        define LIRC_VALUE                                                               \
            ((uint32_t)32000) /*!< Value of the Internal Low speed oscillator in         \
                                 Hz*/
#    endif                    /* LIRC_VALUE */
/**
...
#    define __NVIC_PRIO_BITS                                                             \
        2U /*!< SC32R803 uses 2 Bits for the Priority Levels 			*/
...
/**
 * @brief SC32R803 Interrupt Number Definition, according to the selected device
...
typedef enum {
    ...
    /******  SC32R803 specific Interrupt Numbers
     ****************************************************************/
 ...
 */
/**
 * @brief UART0-1 for APB0,UART2 for APB1,UART3 for APB2,UART0/2/3 Peripheral offset
 * =0x20,UART1 Peripheral offset=0x80
 */
typedef struct {
    ...
    __IO uint32_t
        UART_DATA; /*!< UART Data register,   			Address offset: 0x0C */
    __IO uint32_t
        UART_IDE; /*!< UART Interrupt /Dma Enable register,   Address offset: 0x10 */
} UART_TypeDef;
...
typedef struct {
    ...
    __IO uint32_t TWI_SPIx_ADD; /*!< Reserved, 									Address
                                   offset: 0x08 */
    __IO uint32_t
        TWI_SPIx_DATA; /*!< SPI Data register,   			Address offset: 0x0C */
    __IO uint32_t
        TWI_SPIx_IDE; /*!< SPI Interrupt /Dma Enable register,   Address offset: 0x10 */
} TWI_SPIx_TypeDef;
/**
 * @brief SPI0/1 for APB0 ,Peripheral offset =0x40 SPI2/3 for APB1 ,Peripheral offset
 * =0x40
 */
typedef struct {
    ...
    __IO uint32_t SPIx_ADD; /*!< Reserved, 									Address
                               offset: 0x08 */
    __IO uint32_t SPI_DATA; /*!< SPI Data register,   			Address offset: 0x0C */
    __IO uint32_t
        SPI_IDE; /*!< SPI Interrupt /Dma Enable register,   Address offset: 0x10 */
} SPI_TypeDef;

/**
 * @brief TWI0/1 for APB0 ,Peripheral offset =0x40 TWI2/3 for APB1 ,Peripheral offset
 * =0x40
 */
typedef struct {
    ...
    __IO uint32_t
        TWI_IDE; /*!< TWI Interrupt /Dma Enable register,   Address offset: 0x10 */
} TWI_TypeDef;
 ...
 */
typedef struct {
    __IO uint32_t QSPI_CON; /*!< TWI_QSPI0 Control register,      Address offset: 0x00 */
    __IO uint32_t QSPI_STS; /*!< TWI_QSPI0 Status register,       Address offset: 0x04 */
    __IO uint32_t
        QSPI_ADD; /*!< TWI_QSPI0 Address register, 		      Address offset: 0x08 */
    __IO uint32_t
        QSPI_DATA; /*!< TWI_QSPI0 Data register,   			Address offset: 0x0C */
    __IO uint32_t
        QSPI_IDE; /*!< TWI_QSPI0 Interrupt /Dma Enable register,   Address offset: 0x10 */
    __IO uint32_t QSPI_DL; /*!< TWI_QSPI0 Data Length register,   Address offset: 0x14 */
    __IO uint32_t RESERVED0; /*!< TWI_QSPI0 Resever0 register,   Address offset: 0x18 */
    __IO uint32_t
        QSPI_REV; /*!< TWI_QSPI0 Resever register,   			Address offset: 0x1C */
} QSPI_TypeDef;
/**
...
typedef struct {
    ...
    __IO uint32_t
        TIM_PDTA_RCAP; /*!< TIMER Rise Caputre Key register,   Address offset: 0x10 */
    __IO uint32_t
        TIM_PDTB_FCAP; /*!< TIMER fall Caputre register,   Address offset: 0x14 */
    __IO uint32_t
        TIM_IDE; /*!< TIMER Interrupt /Dma Enable register,  Address offset: 0x18 */
} TIM_TypeDef;
...
typedef struct {
    ...
    __IO uint32_t
                  PWM_CYCLE;   /*!< PWM Cycles register,  			Address offset: 0x18 */
    __IO uint32_t RESERVED[5]; /*!< Reserved, 									Address
                                  offset: 0x1C */
    __IO uint32_t PWM_DT[8];   /*!< PWM Duty register,@PWM PWM_DT[8] is Valied, 	Address
                                  offset: 0x30 */
} PWM_TypeDef;
/**
...
typedef struct {
    __IO uint32_t
        LEDPWM_CON; /*!< Pwm Control register,             Address offset: 0x00 */
    __IO uint32_t
        LEDPWM_CHN0; /*!< PWM Channel0 register,            Address offset: 0x04 */
    __IO uint32_t
        LEDPWM_STS; /*!< PWM Status register,              Address offset: 0x08 */
    __IO uint32_t
        LEDPWM_INV0; /*!< PWM Inverse0 register,            Address offset: 0x0C */
    __IO uint32_t
        LEDPWM_DFR; /*!< PWM Dead space register,          Address offset: 0x10 */
    __IO uint32_t
        LEDPWM_FLT; /*!< PWM FaiLure detection register,   Address offset: 0x14 */
    __IO uint32_t
        LEDPWM_CYCLE; /*!< PWM Cycles register,              Address offset: 0x18 */
    __IO uint32_t
        LEDPWM_CHN1; /*!< PWM Channel1 register,            Address offset: 0x1C */
    __IO uint32_t
        LEDPWM_INV1; /*!< PWM Inverse1 register,            Address offset: 0x20 */
    __IO uint32_t
        RESERVED[3]; /*!< Reserved,                         Address offset: 0x24~0x2C */
    __IO uint32_t LEDPWM_DT[39]; /*!< PWM Duty register,@PWM PWM_DT[38] is Valied, Address
                                    offset: 0x30 */
} LEDPWM_TypeDef;
/**
...
typedef struct {
    ...
    __IO uint32_t
                  ADC_VALUE; /*!< ADC Value register, 				Address offset: 0x08 */
...
typedef struct {
    ...
    __IO uint32_t
        CMP_CFG; /*!< CMP Config register, 				Address offset: 0x04 */
} CMP_TypeDef;
...
typedef struct {
    ...
    __IO uint32_t RESERVED[2]; /*!< Reserved,
                                  Address offset: 0x04 */
    __IO uint32_t
        TK_CON; /*!< TK Control register, 				  Address offset: 0x0C */
    __IO uint32_t
                  TK_CFG;    /*!< TK Config register, 				  	Address offset: 0x10 */
    __IO uint32_t RESERVED0; /*!< Reserved,
                                Address offset: 0x14 */
    __IO uint32_t TK_CNT;    /*!< TK RawData register, 				  Address offset: 0x18
                              */
    __IO uint32_t TK_TM;     /*!< TK TM register, 				 				Address
                                offset: 0x1C */
} TK_TypeDef;
...
typedef struct {
    __IO uint32_t
        DDR_CON; /*!< Display Drive Control register,      Address offset: 0x00 */
    __IO uint32_t DDR_CFG; /*!< Display Drive Config register, 	  Address offset: 0x04 */
    __IO uint32_t
        SEG_EN0; /*!< Segment IO Enable register, 		  Address offset: 0x08 */
    __IO uint32_t
                  SEG_EN1; /*!< Segment IO Enable register, 		  Address offset: 0x0C */
...
typedef struct {
    ...
    __IO uint32_t
        PXLEV; /*!< GPIO port Level register, 					Address offset: 0x60 */
} GPIO_TypeDef;
...
typedef struct {
    __IO uint8_t
        PIN_BIT[16]; /*!< GPIOA,B,C Bit register,               Address offset: 0x00 */
    __IO uint8_t
        PIN_XR[16]; /*!< GPIOA,B,C Bit register,               Address offset: 0x20 */
} GPIO_BIT_TypeDef;
...
typedef struct {
    ...
    __IO uint32_t RESERVED0[7]; /*!< Reserved, Address offset: 0x04 			*/
    __IO uint32_t INTR_IE;      /*!< INT Rise edge Enable register register,       Address
                                   offset: 0x20     	*/
    __IO uint32_t RESERVED1[7]; /*!< Reserved, Address offset: 0x24 			*/
...
typedef struct {
    ...
    __IO uint32_t
                  IAP_SNB;   /*!< IAP Sector Number register, 			Address offset: 0x04 */
...
typedef struct {
    ...
    __IO uint32_t
        DMA_DADR;          /*!< DMA Destination Adress register, 		Address offset: 0x04 */
...
typedef struct {
    __IO uint32_t
        CAN_RX_ID; /*!< CAN Receive Buffer ID register,    Address offset: 0x00 */
    __IO uint32_t
        CAN_RX_CTRL; /*!< CAN Receive Control register,    Address offset: 0x04 */
    __IO uint32_t
        CAN_RBUF[16]; /*!< CAN Receive Buffer0 register,      Address offset: 0x08 */
    __IO uint32_t
        CAN_RTSL; /*!< CAN Receive TimeStampLow register,    Address offset: 0x48 */
    __IO uint32_t
        CAN_RTSH; /*!< CAN Receive TimeStampHigh register,    Address offset: 0x4C */
} CAN_RX_BUFFER_TypeDef;

typedef struct {
    __IO uint32_t
        CAN_TX_ID; /*!< CAN Transmit Buffer ID register,  Address offset: 0x50 */
    __IO uint32_t
        CAN_TX_CTRL; /*!< CAN Transmit Control register,    Address offset: 0x54 */
    __IO uint32_t
        CAN_TBUF[16];       /*!< CAN Transmit Buffer0 register,    Address offset: 0x58 */
    __IO uint32_t CAN_TTSL; /*!< CAN TimestampLow Timer register, Address offset: 0x98 */
    __IO uint32_t
        CAN_TTSH; /*!< CAN TimestampHigh Timer register,    Address offset: 0x9C */
...
typedef struct {
    ...
    __IO uint32_t CAN_TTSH; /*!< CAN Transmit TimeStampHigh register, Address offset: 0x9C
                             */
    __IO uint32_t
        CAN_CFG_STAT; /*!< CAN Configure Status register,                      Address
                         offset: 0xA0 */
    __IO uint32_t CAN_RTIE; /*!< CAN Receive and Transmit Interrup register, Address
                               offset: 0xA4 */
    __IO
        uint32_t CAN_S_SEG; /*!< CAN Timing register (slow speed), Address offset: 0xA8 */
    __IO
        uint32_t CAN_F_SEG; /*!< CAN Timing register (fast speed), Address offset: 0xAC */
    __IO uint32_t CAN_EALCAP;  /*!< CAN Error and Arbitration Lost Capture register,
                                  Address offset: 0xB0 */
    __IO uint32_t CAN_ACFCTRL; /*!< CAN Acceptance Filter Control register, Address
                                  offset: 0xB4 */
    ...
    __IO uint32_t
        TTCAN_RFMSG; /*!< TTCAN Reference Message register,                   Address
                        offset: 0xC0 */
    __IO uint32_t
        TTCAN_TRIG_CFG; /*!< TTCAN Trigge Configure register,                    Address
                           offset: 0xC4 */
    __IO uint32_t
        TTCAN_WTRIG; /*!< TTCAN Watch Trigger Time register,                  Address
                        offset: 0xC8 */
...
#    define APB0_RST_QSPI0RST_Pos (4U)
#    define APB0_RST_QSPI0RST_Msk (0x1UL << APB0_RST_QSPI0RST_Pos)
#    define APB0_RST_QSPI0RST APB0_RST_QSPI0RST_Msk

#    define APB0_RST_TWI2RST_Pos (5U)
#    define APB0_RST_TWI2RST_Msk (0x1UL << APB0_RST_TWI2RST_Pos)
#    define APB0_RST_TWI2RST APB0_RST_TWI2RST_Msk

#    define APB0_RST_SPI2RST_Pos (5U)
#    define APB0_RST_SPI2RST_Msk (0x1UL << APB0_RST_SPI2RST_Pos)
#    define APB0_RST_SPI2RST APB0_RST_SPI2RST_Msk
...
#    define APB1_RST_QSPI1RST_Pos (4U)
#    define APB1_RST_QSPI1RST_Msk (0x1UL << APB1_RST_QSPI1RST_Pos)
#    define APB1_RST_QSPI1RST APB1_RST_QSPI1RST_Msk

#    define APB1_RST_TWI3RST_Pos (5U)
#    define APB1_RST_TWI3RST_Msk (0x1UL << APB1_RST_TWI3RST_Pos)
#    define APB1_RST_TWI3RST APB1_RST_TWI3RST_Msk

#    define APB1_RST_SPI3RST_Pos (5U)
#    define APB1_RST_SPI3RST_Msk (0x1UL << APB1_RST_SPI3RST_Pos)
#    define APB1_RST_SPI3RST APB1_RST_SPI3RST_Msk
...
#    define TK_CON_CTIME_Msk (0x0FL << TK_CON_CTIME_Pos)
...
#    define CAN_RX_ID_ESI_Pos (31U)
#    define CAN_RX_ID_ESI_Msk (0x1L << CAN_RX_ID_ESI_Pos)
#    define CAN_RX_ID_ESI CAN_RX_ID_ExID_Msk
...
#    define CAN_RX_CTRL_KOER_Msk (0x7L << CAN_RX_CTRL_KOER_Pos)
...
#    define CAN_EALCAP_KOER_Msk (0x7L << CAN_EALCAP_KOER_Pos)
...
#    define TTCAN_RFMSG_REF_ID_Msk (0xFFFFFFL << TTCAN_RFMSG_REF_ID_Pos)
...
#    define TTCAN_TRIG_CFG_TTYPE_Msk (0x7L << TTCAN_TRIG_CFG_TTYPE_Pos)
...
#    define TTCAN_TRIG_CFG_TT_TRIG_Msk (0xFFFFL << TTCAN_TRIG_CFG_TT_TRIG_Pos)
...
/*                                                                            */
/******************************************************************************/
/********************  Bit definition for OPT0_CON0 register  ********************/
#    define COPT0_CFG_LVRS_Pos (0U)
#    define COPT0_CFG_LVRS_Msk (0x1L << COPT0_CFG_LVRS_Pos)
...
/*                                                                            */
/******************************************************************************/
/********************  Bit definition for OPT1_CON1 register  ********************/
