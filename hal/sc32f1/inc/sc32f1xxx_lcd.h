...
typedef enum {
    LCD_FrameFre_A32Hz =
        (uint32_t)((0x00U << DDR_CON_DDRCK_Pos) |
                   DDR_CON_TYPE), /*!< The LCD/LED frame frequency of typeA is 32Hz */
    LCD_FrameFre_A64Hz =
        (uint32_t)((0x01U << DDR_CON_DDRCK_Pos) |
                   DDR_CON_TYPE), /*!< The LCD/LED frame frequency of typeA is 64Hz */
    LCD_FrameFre_A128Hz =
        (uint32_t)((0x02U << DDR_CON_DDRCK_Pos) |
                   DDR_CON_TYPE), /*!< The LCD/LED frame frequency of typeA is 128Hz */
    LCD_FrameFre_B64Hz =
        (uint32_t)(0x00U << DDR_CON_DDRCK_Pos), /*!< The LCD/LED frame frequency of typeB
                                                   is 64Hz */
    LCD_FrameFre_B128Hz =
        (uint32_t)(0x01U << DDR_CON_DDRCK_Pos), /*!< The LCD/LED frame frequency of typeB
                                                   is 128Hz*/
    LCD_FrameFre_B256Hz =
        (uint32_t)(0x02U << DDR_CON_DDRCK_Pos), /*!< The LCD/LED frame frequency of typeB
                                                   is 256Hz*/
    LCD_FrameFre_ACustom =
        (uint32_t)(DDR_CON_TRIMODE | DDR_CON_TYPE), /*!< The LCD/LED frame frequency of
                                                       typeA is customized*/
    LCD_FrameFre_BCustom = (uint32_t)(DDR_CON_TRIMODE), /*!< The LCD/LED frame frequency
                                                           of typeB is customized*/
} LCD_FrameFre_TypeDef;

#define IS_LCD_FRAMEFRE(FRAMEFRE)                                                        \
    (((FRAMEFRE) == LCD_FrameFre_A32Hz) || ((FRAMEFRE) == LCD_FrameFre_A64Hz) ||         \
     ((FRAMEFRE) == LCD_FrameFre_A128Hz) || ((FRAMEFRE) == LCD_FrameFre_B64Hz) ||        \
     ((FRAMEFRE) == LCD_FrameFre_B128Hz) || ((FRAMEFRE) == LCD_FrameFre_B256Hz) ||       \
     ((FRAMEFRE) == LCD_FrameFre_B128Hz) || ((FRAMEFRE) == LCD_FrameFre_B256Hz))
/**
 * @}
 */
...
typedef enum {
    LCD_Duty_1_8 =
        (uint32_t)(0x00U << DDR_CFG_DUTY_Pos), /*!< LCD/LED display duty cycle: 1/8    */
    LCD_Duty_1_6 =
        (uint32_t)(0x01U << DDR_CFG_DUTY_Pos), /*!< LCD/LED display duty cycle: 1/6    */
    LCD_Duty_1_5 =
        (uint32_t)(0x02U << DDR_CFG_DUTY_Pos), /*!< LCD/LED display duty cycle: 1/5    */
...
typedef enum {
    LCD_Bias_1_4 =
        (uint32_t)(0x00U
                   << DDR_CON_BIAS_Pos), /*!< Display drive bias voltage Settings:1/3 */
    LCD_Bias_1_3 =
        (uint32_t)(0x01U
                   << DDR_CON_BIAS_Pos), /*!< Display drive bias voltage Settings:1/4 */
} LCD_Bias_TypeDef;
...
typedef enum {
    LCD_ResSel_33K =
        (uint8_t)(0x00U << DDR_CON_VOIRSF_Pos), /*!< LCD voltage outlet voltage divider
                                                   resistor:33K */
    LCD_ResSel_100K =
        (uint8_t)(0x01U << DDR_CON_VOIRSF_Pos), /*!< LCD voltage outlet voltage divider
                                                   resistor:100K */
    LCD_ResSel_300K =
        (uint8_t)(0x02U << DDR_CON_VOIRSF_Pos), /*!< LCD voltage outlet voltage divider
                                                   resistor:300K */
    LCD_ResSel_800K =
        (uint8_t)(0x03U << DDR_CON_VOIRSF_Pos), /*!< LCD voltage outlet voltage divider
                                                   resistor:800K */
} LCD_ResSel_TypeDef;
...
typedef struct {
    ...
    uint64_t LCD_SegPin; /*!< Specifies the Seg Pin.
                            ...
                            Seg channel,Support 35 channels.*/
#endif
} LCD_InitTypeDef;
/**
 * @}
