...
#define IS_WDT_OverTime(OVERTIME)                                                        \
    (((OVERTIME) == WDT_OverTime_500MS) || ((OVERTIME) == WDT_OverTime_250MS) ||         \
     ((OVERTIME) == WDT_OverTime_125MS) || ((OVERTIME) == WDT_OverTime_62_5MS) ||        \
     ((OVERTIME) == WDT_OverTime_31_5MS) || ((OVERTIME) == WDT_OverTime_15_75MS) ||      \
     ((OVERTIME) == WDT_OverTime_7_88MS) || ((OVERTIME) == WDT_OverTime_3_94MS))
/**
 * @}
 */
