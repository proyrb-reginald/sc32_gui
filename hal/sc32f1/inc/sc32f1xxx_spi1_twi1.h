...
#ifndef __sc32f1xxx_TWI1_SPI1_H
#define __sc32f1xxx_TWI1_SPI1_H
...
#define IS_SPI1_Mode(MODE) (((MODE) == SPI1_Mode_Master) || ((MODE) == SPI1_Mode_Slave))
/**
 * @}
 */
 ...
 */
typedef enum {
    SPI1_DataSize_8B = (uint32_t)(0X00U << SPI1_CON_SPMD_Pos), /*!< SPI Data Size:Set data
                                                                  frame format to 8bit */
    SPI1_DataSize_16B =
        (uint32_t)(0X01U << SPI1_CON_SPMD_Pos), /*!< SPI Data Size:Set data frame format
                                                   to 16bit */
} SPI1_DataSize_TypeDef;

#define IS_SPI1_DATASIZE(SIZE)                                                           \
    (((SIZE) == SPI1_DataSize_8B) || ((SIZE) == SPI1_DataSize_16B))
/**
 * @}
 */
...
#define IS_SPI1_FIRSTBIT(BIT)                                                            \
    (((BIT) == SPI1_FirstBit_MSB) || ((BIT) == SPI1_FirstBit_LSB))
/**
 * @}
 */
...
typedef enum {
    SPI1_CPHA_1Edge =
        (uint32_t)(0X00U << SPI1_CON_CPHA_Pos), /*!< SPI1 Clock Phase:The first edge
                                                   signal is triggered   */
    SPI1_CPHA_2Edge =
        (uint32_t)(0X01U << SPI1_CON_CPHA_Pos), /*!< SPI1 Clock Phase:The second edge
                                                   signal is triggered    */
} SPI1_CPHA_TypeDef;

#define IS_SPI1_CPHA(CPHA) (((CPHA) == SPI1_CPHA_1Edge) || ((CPHA) == SPI1_CPHA_2Edge))
/**
 * @}
 */
 ...
 */
typedef enum {
    SPI1_CPOL_Low = (uint32_t)(0X00U << SPI1_CON_CPOL_Pos), /*!< SPI1 Clock Polarity:It is
                                                               low in the idle state  */
    SPI1_CPOL_High =
        (uint32_t)(0X01U << SPI1_CON_CPOL_Pos), /*!< SPI1 Clock Polarity:It is high in the
                                                   idle state */
} SPI1_CPOL_TypeDef;

#define IS_SPI1_CPOL(CPOL) (((CPOL) == SPI1_CPOL_Low) || ((CPOL) == SPI1_CPOL_High))
/**
 * @}
 */
...
#define IS_SPI1_TWI1_WorkMode(WorkMode)                                                  \
    (((WorkMode) == WorkeMode_TWI1) || ((WorkMode) == WorkeMode_SPI1))
...
#define IS_TWI1_ACK(STATE) (((STATE) == TWI1_Ack_Disable) || ((STATE) == TWI1_Ack_Enable))
/**
 * @}
 */
 ...
 */
typedef enum {
    TWI1_Stretch_Disable =
        (uint8_t)(0X00U << TWI1_CON_STRETCH_Pos), /*!< TWI1 Slave Clock Stretch:Disable */
    TWI1_Stretch_Enable =
        (uint8_t)(0X01U << TWI1_CON_STRETCH_Pos), /*!< TWI1 Slave Clock Stretch:Enable */
} TWI1_Stretch_TypeDef;

#define IS_TWI1_STRETCH(STRETCH)                                                         \
    (((STRETCH) == TWI1_Stretch_Enable) || ((STRETCH) == TWI1_Stretch_Disable))
/**
 * @}
 */
 ...
 */
typedef enum {
    TWI1_GeneralCall_Disable =
        (uint8_t)(0X00U << TWI1_ADD_GC_Pos), /*!< TWI1 General Call State:Disable    */
    TWI1_GeneralCall_Enable =
        (uint8_t)(0X01U << TWI1_ADD_GC_Pos), /*!< TWI1 General Call State:Enable    */
} TWI1_GeneralCall_TypeDef;

#define IS_TWI1_GENERALCALL(GENERALCALL)                                                 \
    (((GENERALCALL) == TWI1_GeneralCall_Disable) ||                                      \
...
#define IS_TWI1_COMMAND(COMMAND)                                                         \
    (((COMMAND) == TWI1_Command_Write) || ((COMMAND) == TWI1_Command_Read))
/**
 * @}
 */
 ...
 */
typedef enum {
    SPI1_TWI1_PinRemap_Default =
        (uint32_t)(0x00 << SPI1_TWI1_CON_SPOS_Pos), /*!< SPI1_TWI1 Pin Remap: Disable */
    SPI1_TWI1_PinRemap_A =
        (uint32_t)(0x01
                   << SPI1_TWI1_CON_SPOS_Pos), /*!< SPI1_TWI1 Pin Remap: Remap mode A */
    SPI1_TWI1_PinRemap_B =
        (uint32_t)(0x02
                   << SPI1_TWI1_CON_SPOS_Pos), /*!< SPI1_TWI1 Pin Remap: Remap mode B */
    SPI1_TWI1_PinRemap_C =
        (uint32_t)(0x03
                   << SPI1_TWI1_CON_SPOS_Pos), /*!< SPI1_TWI1 Pin Remap: Remap mode C */
} SPI1_TWI1_PinRemap_TypeDef;

#define IS_SPI1_TWI1_LIST1_PINREMAP(REMAP)                                               \
    (((REMAP) == SPI1_TWI1_PinRemap_Default) || ((REMAP) == SPI1_TWI1_PinRemap_A) ||     \
     ((REMAP) == SPI1_TWI1_PinRemap_B) || ((REMAP) == SPI1_TWI1_PinRemap_C))
...
#define IS_TWI1_STATEMACHINE(STATE)                                                      \
    (((STATE) == TWI1_Slave_Idle) || ((STATE) == TWI1_Slave_ReceivedaAddress) ||         \
     ((STATE) == TWI1_Slave_ReceivedaData) || ((STATE) == TWI1_Slave_SendData) ||        \
     ((STATE) == TWI1_Master_Idle) || ((STATE) == TWI1_Master_SendAddress) ||            \
     ((STATE) == TWI1_Master_SendData) || ((STATE) == TWI1_Master_ReceivedaData))
/**
 * @}
 */
...
#define IS_SPI1_IT(IT) (((IT) == SPI1_IT_INT) || ((IT) == SPI1_IT_TBIE))
...
#define IS_SPI1_DMAReq(DMAREQ)                                                           \
    (((DMAREQ) == SPI1_DMAReq_RX) || ((DMAREQ) == SPI1_DMAReq_TX))
/**
 * @}
 */
...
#define IS_SPI1_FLAG(FLAG)                                                               \
    (((FLAG) == SPI1_FLAG_QTWIF) || ((FLAG) == SPI1_FLAG_TXEIF) ||                       \
     ((FLAG) == SPI1_FLAG_WCOL))
...
typedef enum {
    ...
    TWI1_FLAG_TXRXnE =
        (uint8_t)TWI1_STS_TXERXE, /*!< TWI1 Flag: Transmit/receive completion flag */
    TWI1_FLAG_GCA = (uint8_t)TWI1_STS_GCA, /*!< TWI1 Flag: Generic Call flags */
} TWI1_FLAG_TypeDef;

#define IS_TWI1_FLAG(FLAG)                                                               \
    (((FLAG) == TWI1_FLAG_QTWIF) || ((FLAG) == TWI1_FLAG_TXRXnE) ||                      \
     ((FLAG) == TWI1_FLAG_GCA))
/**
 * @}
 */
...
typedef struct {
    ...
    uint32_t
        TWI1_SlaveAdress; /*!< This member configures TWI SlaveAdress.
...
void    TWI1_Send7bitAddress(SPITWI_TypeDef *     TWIx,
                             uint8_t              Address,
                             TWI1_Command_TypeDef TWI1_Command);
void    TWI1_SendData(SPITWI_TypeDef * TWIx, uint16_t Data);
uint8_t TWI1_ReceiveData(SPITWI_TypeDef * TWIx);
TWI1_StateMachine_TypeDef TWI1_GetStateMachine(SPITWI_TypeDef * TWIx);
/* Pin remap management functions  **********************************************/
void SPI1_TWI1_PinRemapConfig(SPITWI_TypeDef *           SPIx_TWIx,
                              SPI1_TWI1_PinRemap_TypeDef TWI1_Remap);
/* Interrupts, DMA and flags management functions
 * **********************************************/
...
void       SPI1_DMACmd(SPITWI_TypeDef *    SPIx,
                       SPI1_DMAReq_TypeDef SPI1_DMAReq,
                       FunctionalState     NewState);
void       SPI1_TWI1_PinRemapConfig(SPITWI_TypeDef *           SPIx_TWIx,
                                    SPI1_TWI1_PinRemap_TypeDef SPI1_TWI1_Remap);
/**
 * @}
 */
/* End of functions --------------------------------------------------*/
