...
#define IS_DMA_PROIORITY(PROIORITY)                                                      \
    (((PROIORITY) == DMA_Priority_LOW) || ((PROIORITY) == DMA_Priority_MEDIUM) ||        \
     ((PROIORITY) == DMA_Priority_HIGH) || ((PROIORITY) == DMA_Priority_VERY_HIGH))
/**
 * @}
 */
...
#define IS_DMA_CIRCULARMODE(MODE)                                                        \
    (((MODE) == DMA_CircularMode_Disable) || ((MODE) == DMA_CircularMode_Enable))
/**
 * @}
 */
...
typedef enum {
    DMA_DataSize_Byte =
        ((uint32_t)0x00U << DMA_CFG_TXWIDTH_Pos), /*!< Peripheral data alignment: Byte */
    DMA_DataSize_HalfWord =
        ((uint32_t)0x01U
         << DMA_CFG_TXWIDTH_Pos), /*!< Peripheral data alignment: HalfWord */
    DMA_DataSize_Word =
        ((uint32_t)0x02U << DMA_CFG_TXWIDTH_Pos), /*!< Peripheral data alignment: Word */
} DMA_DataSize_TypeDef;

#define IS_DMA_DATASIZE(SIZE)                                                            \
    (((SIZE) == DMA_DataSize_Byte) || ((SIZE) == DMA_DataSize_HalfWord) ||               \
...
typedef enum {
    DMA_TargetMode_FIXED =
        ((uint32_t)0x00U << DMA_CFG_DAINC_Pos), /*!< DMA Target Mode: Fixed address */
    DMA_TargetMode_INC =
        ((uint32_t)0x01U << DMA_CFG_DAINC_Pos), /*!< DMA Target Mode: Address increase */
    DMA_TargetMode_DEC =
        ((uint32_t)0x02U << DMA_CFG_DAINC_Pos), /*!< DMA Target Mode: Address decrease */
...
typedef enum {
    DMA_SourceMode_FIXED =
        ((uint32_t)0x00U << DMA_CFG_SAINC_Pos), /*!< DMA Source Mode: Fixed address */
    DMA_SourceMode_INC =
        ((uint32_t)0x01U << DMA_CFG_SAINC_Pos), /*!< DMA Source Mode: Address increase */
    DMA_SourceMode_DEC =
        ((uint32_t)0x02U << DMA_CFG_SAINC_Pos), /*!< DMA Source Mode: Address decrease */
...
typedef enum {
    ...
    DMA_Request_UART0_TX =
        ((uint32_t)0x0002U << DMA_CFG_REQSRC_Pos), /*!< DMA Requtest: UART0 TX */
    DMA_Request_UART0_RX =
        ((uint32_t)0x0003U << DMA_CFG_REQSRC_Pos), /*!< DMA Requtest: UART0 RX */
    ...
    DMA_Request_DMA1 =
        ((uint32_t)0x003FU << DMA_CFG_REQSRC_Pos), /*!< DMA Requtest: DMA1    */
#endif
} DMA_Request_TypeDef;
...
typedef enum {
    ...
    DMA_State_SOURCE =
        ((uint32_t)0x01U << DMA_STS_STATUS_Pos), /*!< DMA write source address */
    DMA_State_BUSY = ((uint32_t)0x02U
                      << DMA_STS_STATUS_Pos), /*!< DMA reads the source address data and
                                                 writes to the destination address */
    DMA_State_DESTINATION =
        ((uint32_t)0x03U << DMA_STS_STATUS_Pos), /*!< DMA write destination address */
    ...
    DMA_State_BURST =
        ((uint32_t)0x06U << DMA_STS_STATUS_Pos), /*!< DMA Burst transmission */
...
typedef enum {
    ...
    DMA_FLAG_TCIF =
        ((uint8_t)
             DMA_STS_TCIF), /*!< DMA FLAG: Transmission completion interrupt flag bit */
    DMA_FLAG_HTIF =
        ((uint8_t)DMA_STS_HTIF), /*!< DMA FLAG: Transmit half interrupt flag */
    DMA_FLAG_TEIF =
        ((uint8_t)DMA_STS_TEIF), /*!< DMA FLAG: Transmission error interrupt flag   */
} DMA_Flag_TypeDef;

#define IS_DMA_FLAG(FLAG)                                                                \
    ((((FLAG) & (uint8_t)0xF0) == 0x00) && ((FLAG) != (uint8_t)0x00))

#define IS_GET_DMA_FLAG(FLAG)                                                            \
    (((FLAG) == DMA_FLAG_GIF) || ((FLAG) == DMA_FLAG_TCIF) ||                            \
     ((FLAG) == DMA_FLAG_HTIF) || ((FLAG) == DMA_FLAG_TEIF))
/**
 * @}
 */
...
typedef struct {
    ...
    uint32_t DMA_Request; /*!< DMA request source.
                                                                     This parameter can be
                             a value of @ref DMA_Request_TypeDef */
