...
#    define __NVIC_PRIO_BITS                                                             \
        2U /*!< sc32f10xx uses 2 Bits for the Priority Levels 			*/
...
typedef enum { Status_OK = 0, Status_ERROR, Status_BUSY, Status_TIMEOUT } StatusTypeDef;
...
typedef struct {
    __IO uint32_t
        LEDPWM_CON; /*!< LEDPWM Control register,      	Address offset: 0x00 */
    __IO uint32_t
        LEDPWM_CHN; /*!< LEDPWM Channel register,       	Address offset: 0x04 */
    __IO uint32_t
        LEDPWM_STS; /*!< LEDPWM Status register, 				Address offset: 0x08 */
    __IO uint32_t
                  LEDPWM_INV;   /*!< LEDPWM Inverse register,   			Address offset: 0x0C */
    __IO uint32_t RESERVED0[2]; /*!< Reserved, 									Address
                                   offset: 0x1C */
    __IO uint32_t
                  LEDPWM_CYCLE;  /*!< LEDPWM Cycles register,  			Address offset: 0x18 */
    __IO uint32_t RESERVED1[5];  /*!< Reserved, 									Address
                                    offset: 0x1C */
    __IO uint32_t LEDPWM_DT[32]; /*!< LEDPWM Duty register,@LEDPWM0 LEDPWM_DT[8] is
...
typedef struct {
    ...
    __IO uint32_t SEGRn[28];     /*!< COM port display drive output function register,
                                    Address     offset: 0x50 */
} LCD_LED_TypeDef;
...
typedef struct {
    ...
    __IO uint32_t
                  SYST_CALIB; /*!< RCC Calib  register, 			Address offset: 0x28 */
...
#    define TK_CON_RESC_Msk (0x3L << TK_CON_RESC_Pos)
#    define TK_CON_RESC TK_CON_RESC_Msk

#    define TK_CFG_ICHAC_Pos (30U)
#    define TK_CFG_ICHAC_Msk ((uint32_t)0x3UL << TK_CFG_ICHAC_Pos)
...
#    define TK_CFG_ICHA_Pos (8U)
#    define TK_CFG_ICHA_Msk (0xFEL << TK_CFG_ICHA_Pos)
...
#    define SC32F10xSx_NIO_Init()                                                        \
        {                                                                                \
            *(uint32_t *)(GPIOA_BIT_BASE + 0X00000020) |= 0X00000006;                    \
            *(uint32_t *)(GPIOB_BIT_BASE + 0X00000020) |= 0X00009000;                    \
        }

#    define SC32F10xKx_NIO_Init()                                                        \
        {                                                                                \
            *(uint32_t *)(GPIOA_BIT_BASE + 0X00000020) |= 0X0000003E;                    \
            *(uint32_t *)(GPIOB_BIT_BASE + 0X00000020) |= 0X000090F4;                    \
            *(uint32_t *)(GPIOC_BIT_BASE + 0X00000020) |= 0X00002032;                    \
        }

#    define SC32F10xGx_NIO_Init()                                                        \
        {                                                                                \
            *(uint32_t *)(GPIOA_BIT_BASE + 0X00000020) |= 0X0000003F;                    \
