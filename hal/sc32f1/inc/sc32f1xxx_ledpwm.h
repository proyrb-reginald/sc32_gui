...
typedef enum {
    LEDPWM_PRESCALER_DIV1 =
        (uint16_t)(0x00U << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/1    */
    LEDPWM_PRESCALER_DIV2 =
        (uint16_t)(0x01U << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/2    */
    LEDPWM_PRESCALER_DIV4 =
        (uint16_t)(0x02U << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/4    */
    LEDPWM_PRESCALER_DIV8 =
        (uint16_t)(0x03U << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/8    */
    LEDPWM_PRESCALER_DIV16 =
        (uint16_t)(0x04U << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/16    */
    LEDPWM_PRESCALER_DIV32 =
        (uint16_t)(0x05U << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/32    */
    LEDPWM_PRESCALER_DIV64 =
        (uint16_t)(0x06U << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/64    */
    LEDPWM_PRESCALER_DIV128 =
        (uint16_t)(0x07U << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/128    */
    LEDPWM_PRESCALER_DIV256 =
        (uint16_t)(0x08U << LEDPWM_CON_PWMCLK_Pos), /*!< Clock division: Fsource/256    */
} LEDPWM_Prescaler_TypeDef;

#define IS_LEDPWM_PRESCALER(PRESCALER)                                                   \
    (((PRESCALER) == LEDPWM_PRESCALER_DIV1) || ((PRESCALER) == LEDPWM_PRESCALER_DIV2) || \
     ((PRESCALER) == LEDPWM_PRESCALER_DIV4) || ((PRESCALER) == LEDPWM_PRESCALER_DIV8) || \
...
typedef enum {
    LEDPWM_AlignmentMode_Edge =
        (uint16_t)(0x00U << LEDPWM_CON_PWMMD0_Pos), /*!< Edge Alignment mode */
    LEDPWM_AlignmentMode_Center =
        (uint16_t)(0x01U << LEDPWM_CON_PWMMD0_Pos), /*!< Center Alignment mode */
} LEDPWM_AlignedMode_TypeDef;

#define IS_LEDPWM_AlignedMode(MODE)                                                      \
    (((MODE) == LEDPWM_AlignmentMode_Edge) || ((MODE) == LEDPWM_AlignmentMode_Center))
/**
 * @}
 */
...
typedef enum {
    ...
    LEDPWM_Channel_32_38 = (int32_t)0x8000007FUL, /*!< PMW output channel 32_38 */
} LEDPWM_Channel_Typedef;
...
typedef enum {
    LEDPWM_IT_INTEN =
        (uint16_t)LEDPWM_CON_INTEN, /*!< LEDPWM Interrupt: LEDPWM Interrupt */
} LEDPWM_IT_TypeDef;

#define IS_LEDPWM_IT(IT)                                                                 \
    ((((IT) & (uint16_t)0xFEFF) == 0x00) && ((IT) != (uint16_t)0x0000))
 ...
 */
typedef enum {
    LEDPWM_Flag_LEDPWMIF =
        (uint8_t)LEDPWM_STS_PWMIF, /*!< LEDPWM Interrupt: LEDPWM Interrupt */
} LEDPWM_Flag_TypeDef;

#define IS_LEDPWM_FLAG(FLAG)                                                             \
    ((((FLAG) & (uint8_t)0xFE) == 0x00) && ((FLAG) != (uint8_t)0x00))
...
typedef struct {
    uint16_t LEDPWM_Prescaler; /*!<  Specifies the predivision.
                                                                            This parameter
                                  can be a value of @ref LEDPWM_Prescaler_TypeDef */

    uint16_t LEDPWM_AlignedMode; /*!< Specifies the aligne mode.
                                                                            This parameter
                                    can be a value of @ref LEDPWM_AlignedMode_TypeDef */

    uint8_t LEDPWM_Cycle; /*!< Specifies the cycle.
                           */

    uint64_t
        LEDPWM_OutputChannel; /*!< Specifies the output Channel.
                                                                        This parameter can
                                 be a value of @ref LEDPWM_Channel_Typedef */

    uint64_t
        LEDPWM_LowPolarityChannl; /*!< Specifies the low polarity Channel.
                                                                            This parameter
                                     can be a value of @ref LEDPWM_Channel_Typedef */
#if defined(SC32R803)
    uint32_t
        LEDPWM_OutputChannel0; /*!< Specifies the output Channel.
                                                                        This parameter can
                                  be a value of @ref LEDPWM_Channel_Typedef */

    uint32_t
        LEDPWM_OutputChannel1; /*!< Specifies the output Channel.
                                                                        This parameter can
                                  be a value of @ref LEDPWM_Channel_Typedef */

    uint32_t
        LEDPWM_LowPolarityChannl0; /*!< Specifies the low polarity Channel.
                                                                            This parameter
                                      can be a value of @ref LEDPWM_Channel_Typedef */

    uint32_t
        LEDPWM_LowPolarityChannl1; /*!< Specifies the low polarity Channel.
                                                                            This parameter
                                      can be a value of @ref LEDPWM_Channel_Typedef */
#endif
} LEDPWM_InitTypeDef;
