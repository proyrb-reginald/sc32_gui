 ...
 * @version
 * @date
 * @brief	         CMSIS Cortex-M0 PlUs Device Peripheral Access Layer System Source
 *File.
 * @details
 *****************************************************************************************************
 * @attention
...
/*!< Uncomment the following line if you need to relocate your vector Table in Internal
 * SRAM. */
