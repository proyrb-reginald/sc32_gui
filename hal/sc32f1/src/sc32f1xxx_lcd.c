...
/**
 * @brief  Initializes the peripheral LCD register according to the parameters specified
 * in LCD_InitStruct.
...
void LCD_Init(LCD_InitTypeDef * LCD_InitStruct) {
    ...
    tmpreg |= (uint32_t)(LCD_InitStruct->LCD_FrameFre | LCD_InitStruct->LCD_Bias |
