...
/** @defgroup ADC_Exported_Functions_Group1 Configuration of the ADC computation unit
functions
 ...
 *                  - ADC_ConvMode_Sequence:Continuous sequence mode
 * @retval None
 */
...
/**
 * @brief  Enables or disables the software conversion enable function of the specified
 * ADC.
 * @param  ADCx[out]: select the ADCx peripheral.
 *                  - ADC: Only ADC can be select the ADCx peripheral.
 * @retval None
 ...
 * Flag
 *                  - ADC_IT_EOSIE0:ADC sequence 0 sampling + conversion complete
 * interrupt Flag
 ...
 * @retval None
 */
void ADC_SetThresholds(ADC_TypeDef * ADCx,
