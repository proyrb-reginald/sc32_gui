 ...
 *                  - TIM6:Timer peripheral select TIM6
 *                  - TIM7:Timer peripheral select TIM7
 * @param  TIM_TimeBaseInitStruct[out]:Pointer to structure TIM_TimeBaseInitTypeDef, to be
 *initialized.
 * @retval None
...
void TIM_TIMBaseInit(TIM_TypeDef *             TIMx,
    ...
    tmpreg |= (uint32_t)(TIM_TimeBaseInitStruct->TIM_Prescaler |
                         TIM_TimeBaseInitStruct->TIM_CounterMode |
                         TIM_TimeBaseInitStruct->TIM_WorkMode |
                         (TIM_TimeBaseInitStruct->TIM_EXENX));
 ...
 * @param  TIM_TimeBaseInitStruct[out]:  Pointer to structure TIM_TimeBaseInitTypeDef, to
 * be initialized.
 * @retval None
 */
 ...
 *                  - TIM6:Timer peripheral select TIM6
 *                  - TIM7:Timer peripheral select TIM7
 * @param  TIM_IC_InitStruct[out]: Pointer to structure TIM_IC_InitTypeDef, to be
 *initialized.
 * @retval None
 */
 ...
 *                  - TIM6:Timer peripheral select TIM6
 *                  - TIM7:Timer peripheral select TIM7
 * @param  TIM_PWM_InitStruct[out]:Pointer to structure TIM_PWM_InitTypeDef, to be
 *initialized.
 * @retval None
 */
 ...
 * @param  TIM_PWM_InitStruct: A pointer to the structure TIM_PWM_InitTypeDef that
 * initializes the PWM mode of TIMx.
 * @retval None
 */
 ...
 *                  - TIM6:Timer peripheral select TIM6
 *                  - TIM7:Timer peripheral select TIM7
 * @param  TIM_DMAReq[in]:specifies the SPI DMA transfer request to be enabled or
 *disabled.
